 ...
 */
public class LibGDXExperimentsRunningMan extends BaseScreen {
    ...
    public LibGDXExperimentsRunningMan(Game game) {
        super(game);
    }

    @Override
    public void show() {
        walkSheet = new Texture(Gdx.files.internal("images/running-animation.png"));
